...
public class NeedFaceUnityAcct extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        String isOpen = PreferenceUtil.getString(CrashApplication.getInstance(), PreferenceUtil.KEY_FACEUNITY_ISON);
        ...
        btn_to_main.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PreferenceUtil.persistString(CrashApplication.getInstance(), PreferenceUtil.KEY_FACEUNITY_ISON,
                        isOn + "");
