...
public class STBeautifyNative {
     ...
     * @return 成功返回0，错误返回其他，参考STUtils.ResultCode
     */
    public native int processBufferInGLContext(byte[] pInputImage, int inFormat, int outputWidth, int outputHeight, STHumanAction humanActionInput, byte[] pOutImage, int outFormat, STHumanAction humanActionOutput);
     ...
     * @return 成功返回0，错误返回其他，参考STUtils.ResultCode
     */
    public native int processBufferNotInGLContext(byte[] pInputImage, int inFormat, int outputWidth, int outputHeight, STHumanAction humanActionInput, byte[] pOutImage, int outFormat, STHumanAction humanActionOutput);
     ...
     * @return 成功返回0，错误返回其他，参考STUtils.ResultCode
     */
    public native int processTexture(int textureIn, int outputWidth, int outputHeight, STHumanAction humanActionInput, int textureOut, STHumanAction humanActionOutput);
     ...
     * @return 成功返回0，错误返回其他，参考STUtils.ResultCode
     */
    public native int processTextureAndOutputBuffer(int textureIn, int outputWidth, int outputHeight, STHumanAction humanActionInput, int textureOut, byte[] outputBuf, int format, STHumanAction humanActionOutput);
